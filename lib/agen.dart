...
//         onExport: _exportCanvas,  // <- ADD THIS LINE
//         onImport: () async {      // <- ADD THIS LINE
//           final content = await _loadFromFile();
//           if (content.isNotEmpty) {
//             _importCanvas(content);
//           }
//         },                       // <- ADD THIS LINE
//       ),
//
...
//             children: [
//               // Sidebar Left panel
//               CanvasSidebar(cardCount: _cards.length),
//
//               // Canvas area
//               Expanded(
//                 child: Listener(
...
//                 },
//                 onAddCard: _addCard,
//                 onUndo: _undo, // Add this
//                 onRedo: _redo, // Add this
//               ),
//             ),
//           ),
//         ],
